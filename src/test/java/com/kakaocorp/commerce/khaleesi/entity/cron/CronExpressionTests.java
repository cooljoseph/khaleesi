...
public class CronExpressionTests {
    ...
    public void asterikAndSingleTest() throws Exception {
        MatcherAssert.assertThat(CronExpression.newInstance("0","*", "*", "?", "*", "*")
                .isMatched(LocalDateTime.of(2018, 1, 16, 16, 30))
                , is(true));

        assertThat(CronExpression.newInstance("0","29", "*", "?", "*", "*")
                        .isMatched(LocalDateTime.of(2018, 1, 16, 16, 30))
                , is(false));

        assertThat(CronExpression.newInstance("0","29", "13", "2", "?", "*")
                        .isMatched(LocalDateTime.of(2018, 1, 16, 13, 29))
                , is(true));

        assertThat(CronExpression.newInstance("0","29", "13", "?", "16", "jan")
                        .isMatched(LocalDateTime.of(2018, 1, 16, 13, 29))
                , is(true));
    }
    ...
    public void rangeTest() throws ParseException {
        assertThat(CronExpression.newInstance("0","0-30,40-50", "*", "?", "*", "*")
                        .isMatched(LocalDateTime.of(2018, 1, 16, 16, 30))
                , is(true));

        assertThat(CronExpression.newInstance("0","30", "16", "MON-FRI", "?", "*")
                        .isMatched(LocalDateTime.of(2018, 1, 16, 16, 30))
                , is(true));
    ...
    public void stepTest() throws ParseException{
        assertThat(CronExpression.newInstance("0","0/5", "*", "?", "*", "*")
                        .isMatched(LocalDateTime.of(2018, 1, 16, 16, 30))
                , is(true));
        ...
        assertThat(CronExpression.newInstance("0","0", "*/2", "?", "*", "*")
